...
Deno sandbox: the logic and tests run without either. dspy 3.4.0 requires Deno `>=2.4.5,<3.0.0`:
...
`>=2.4.5,<3.0.0`); `examples/mini_run.py` shows it. To drive the real forward
